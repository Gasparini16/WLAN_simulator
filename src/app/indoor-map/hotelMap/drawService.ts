...
export class DrawService {
  ...
  let legendGradient = context.createLinearGradient(0,0,0,170);
    ...
    legendGradient.addColorStop(offsets[20],'rgb(220,240,100)');
    legendGradient.addColorStop(offsets[21],'rgb(180,240,0)');
    legendGradient.addColorStop(offsets[22],'rgb(160,240,0)');
    legendGradient.addColorStop(offsets[23],'rgb(130,240,0)');
    legendGradient.addColorStop(offsets[24],'rgb(90,240,0)');
    legendGradient.addColorStop(offsets[25],'rgb(40,255,0)');
    legendGradient.addColorStop(offsets[26],'rgb(120,240,150)');
    legendGradient.addColorStop(offsets[27],'rgb(100,240,180)');
    legendGradient.addColorStop(offsets[28],'rgb(60,240,180)');
    legendGradient.addColorStop(offsets[29],'rgb(0,255,240)');
    legendGradient.addColorStop(offsets[30],'rgb(0,160,240)');
    legendGradient.addColorStop(offsets[31],'rgb(0,130,255)');
    legendGradient.addColorStop(offsets[32],'rgb(0,120,240)');
    legendGradient.addColorStop(offsets[33],'rgb(120,80,255)');
    legendGradient.addColorStop(offsets[34],'rgb(150,0,255)');
